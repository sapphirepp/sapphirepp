...
void VFPEquationSolver::make_grid_shock() {
  ...
  const unsigned int n_cells_shock = 2 * shock_width / step_size_shock;
  ...
  // // injection momentum be linear to resolve the point like injection, i.e.
  // the
  // // standard deviation of the Gaussian needs to resolved. p_0 +- 2 * sigma_p
  // is
  ...
  // equidistant momentum
  double p_min = std::log(0.1);
  double p_max = std::log(100);
  ...
  //      i < additional_cells_p_minus + 2 * n_cells_injection_p +
  //      n_correction_cells; ++i, ++j) {
  ...
  // }
  // for (unsigned int i = additional_cells_p_minus + 2 * n_cells_injection_p +
  // n_correction_cells;
  //      i < additional_cells_p_minus + 2 * n_cells_injection_p +
  //      n_correction_cells +
