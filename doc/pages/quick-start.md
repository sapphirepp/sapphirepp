...
software like @paraview or [VisIt](https://visit-dav.github.io/visit-website/).
A [detailed tutorial](#paraview-tutorial) on how to visualise the results using
@paraview is given in the next section on [Visualization](#visualization). Here
we just present the results to give a first impression.
