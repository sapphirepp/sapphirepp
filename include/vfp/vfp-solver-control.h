...
namespace Sapphire
{
  ...
  public:
    ...
    // every stage of the Runge-Kutta method. Actually it only has to be
    // assembled once at time zero.
    ...
    // spatial advection term is included in the equation or the dimension of
    // the configuration space is set to zero.
    static_assert(
