        ...
        case 0:
          {
            ...
            /**Since std::pow() has pretty slow implementations on some systems,
             * we replace it by logarithm followed by exponentiation (of base
             * 2), which is mathematically equivalent but usually much better
             * optimized */
