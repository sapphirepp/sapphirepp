...
/**
 * @file
 * examples/vfp/steady-state-parallel-shock-with-synchrotron-losses/steady-state-parallel-shock-with-synchrotron-losses.cpp
 * @author Florian Schulze (florian.schulze@mpi-hd.mpg.de)
 * @brief Implement main function for parallel-shock with synchrotron-losses example
 */
