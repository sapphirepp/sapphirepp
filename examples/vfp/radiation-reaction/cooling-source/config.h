...
namespace sapphirepp
{
  ...
  public:
    ...
    declare_parameters(dealii::ParameterHandler &prm)
    {
      ...
      prm.add_parameter("p_inj", p_inj, "Injection momentum of the particles.");
      prm.add_parameter("sigma_p", sigma_p, "Width of the Gaussian injection.");
      prm.add_parameter("injection_rate", injection_rate, "Injection rate.");
      /** [Declare runtime parameter] */
