...
/**
 * @file examples/vfp/boundary-conditions/periodic-bc/config.h
 * @author Nils Schween (nils.schween@mpi-hd.mpg.de)
 * @brief Implement physical setup for periodic-bc example
 */
...
namespace sapphirepp
{
  ...
  public:
    ...
    declare_parameters(dealii::ParameterHandler &prm)
    {
      ...
      prm.add_parameter("ux", ux, "Fluid velocity in x-direction");
      /** [Declare runtime parameter] */
