...
/**
 * @file examples/vfp/boundary-conditions/continuous-bc/config.h
 * @author Nils Schween (nils.schween@mpi-hd.mpg.de)
 * @brief Implement physical setup for continuous-bc example
 */
...
namespace sapphirepp
{
  ...
  public:
    ...
    declare_parameters(dealii::ParameterHandler &prm)
    {
      ...
      prm.add_parameter("B0/2pi", B0_2pi, "Magnetic field strength");
