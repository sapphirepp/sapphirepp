...
/**
 * @file examples/vfp/boundary-conditions/reflective-bc/config.h
 * @author Nils Schween (nils.schween@mpi-hd.mpg.de)
 * @brief Implement physical setup for reflective-bc example
 */
...
namespace sapphirepp
{
  ...
  public:
    ...
    declare_parameters(dealii::ParameterHandler &prm)
    {
      ...
      prm.add_parameter("u0", u0, "Velocity of the background plasma");
      prm.add_parameter("sigma",
                        sigma,
